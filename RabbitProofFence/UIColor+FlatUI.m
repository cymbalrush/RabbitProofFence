...
+ (UIColor *) greenSeaColor {
    return [UIColor colorFromHexCode:@"2cb8a3"];
}
...
+ (UIColor *) tealColor {
    return [UIColor colorFromHexCode:@"008080"];
}

+ (UIColor *) vfActiveColor {
    return [UIColor colorFromHexCode:@"EB0026"];
}

+ (UIColor *) vfGrayColor {
    return [UIColor colorFromHexCode:@"EDEDED"];
}

+ (UIColor *) twitterColor {
    return [UIColor colorFromHexCode:@"4099FF"];
}
